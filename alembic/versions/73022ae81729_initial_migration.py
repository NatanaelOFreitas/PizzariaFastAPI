...
Revision ID: 73022ae81729
Revises: 
Create Date: 2026-02-19 17:24:39.171288
...
def upgrade() -> None:
    ...
    sa.Column('tamanho', sqlalchemy_utils.types.choice.ChoiceType(length=255), nullable=True),
